...
public class TelemetryClient {
	...
	public void send(String message) {
		...
		// The simulation of Send() actually just remember if the last message
		// sent was a diagnostic message.
		// This information will be used to simulate the Receive(). Indeed there
	...
	public String receive() {
		...
		if (diagnosticMessageJustSent) {
			...
			// Simulate the reception of a response message returning a random
			// message.
			message = "";
